...
const portableTextComponents: PortableTextProps["components"] = {
  types: {
    ...
    code: ({ value }) => {
      return (
                  <div className="grid my-4 overflow-x-auto rounded-lg border text-xs lg:text-sm bg-primary/80 dark:bg-muted/80">
                      <div className="flex items-center justify-between px-4 py-2 border-b bg-primary/80 dark:bg-muted">
  ...
  block: {
    normal: ({ children }) => (
      <p style={{ marginBottom: "1rem", fontSize: "1.1rem" }}>{children}</p>
    ),
    h1: ({ children }) => (
