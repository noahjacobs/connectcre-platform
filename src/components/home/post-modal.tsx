    ...
    <AnimatePresence>
      {showModal && (
        <motion.div
          ...
          className="fixed inset-0 z-50 bg-black/80 backdrop-blur-sm flex items-center justify-center p-0 m-0"
            ...
            <div className="flex-1 overflow-y-auto modal-scroll-container">
              ...
              {!isLoading && !error && modalData?.post && (
                <PostLayout
                  ...
                  onCloseModal={onClose} // Pass POST modal closer
                  onDataNeedsRefresh={onRefresh} // <-- Pass the refresh handler
                  isModalView={true}
                />
              )}
            </div>
