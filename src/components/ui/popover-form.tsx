  ...
  return (
    ...
    >
      <motion.button
        ...
        className="flex h-8 items-center border bg-white dark:bg-[#121212] hover:bg-zinc-100 dark:hover:bg-zinc-900 px-2.5 text-sm font-medium outline-none"
      >
      ...
      <AnimatePresence>
        {open && (
          <motion.div
            layoutId={`${title}-wrapper`}
            className="absolute top-0 p-1 overflow-hidden bg-muted shadow-[0_0_0_1px_rgba(0,0,0,0.08),0px_1px_2px_rgba(0,0,0,0.04)] outline-none z-60"
            ref={ref}
...
export function PopoverFormButton({
  ...
  return (
    <button
      type="submit"
      className="ml-auto flex h-8 w-auto items-center justify-center overflow-hidden rounded-md bg-linear-to-b from-primary/90 to-primary px-4 text-sm font-semibold text-primary-foreground shadow-[0_0_1px_1px_rgba(255,255,255,0.08)_inset,0_1px_1.5px_0_rgba(0,0,0,0.32),0_0_0_0.5px_#1a94ff]"
    >
